...
import { Leaf, Activity, Zap, Award, AlertTriangle, Globe, ArrowRight, CheckCircle, ChevronDown } from 'lucide-react' // Added ChevronDown
...
function App() {
  ...
  // NEW: Reset function to go back to home
  const handleReset = () => {
    setResult(null);
    setUrl('');
    setError(null);
