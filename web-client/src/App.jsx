  ...
  return (
    <div className="container">
      ...
      <nav className="navbar">
        <div 
          className="logo" 
          onClick={() => { setCurrentView('dashboard'); handleReset(); }} 
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <button 
            ...
            onClick={() => setCurrentView(currentView === 'dashboard' ? 'integration' : 'dashboard')}
          >
            {currentView === 'dashboard' ? (
              <span style={{ display: 'flex', gap: '5px', alignItems: 'center' }}><Code size={16}/> Docs & API</span>
            ) : (
              'Back to Dashboard'
            )}
          </button>
          
          {result && currentView === 'dashboard' && (
